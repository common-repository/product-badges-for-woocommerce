                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="pbfw_pro_condition regular-text" name="pbfw_pro_condition">
                                        ...
                                        <option value="price" disabled <?php if($pro_con == "price") { echo "selected"; } ?>><?php echo __( 'Price', 'product-badges-for-woocommerce' );?> (Get Pro) </option>
                                        <option value="category" disabled <?php if($pro_con == "category") { echo "selected"; } ?>><?php echo __( 'Category', 'product-badges-for-woocommerce' );?> (Get Pro) </option>
                                        <option value="tag" disabled <?php if($pro_con == "tag") { echo "selected"; } ?>><?php echo __( 'Tag', 'product-badges-for-woocommerce' );?> (Get Pro) </option>
                                        <option value="onsale" <?php if($pro_con == "onsale") { echo "selected"; } ?>><?php echo __( 'On Sale', 'product-badges-for-woocommerce' );?></option>
                                        <option value="outofstock" disabled <?php if($pro_con == "outofstock") { echo "selected"; } ?>><?php echo __( 'Out of Stock', 'product-badges-for-woocommerce-pro' );?> (Get Pro)</option>
                                    </select>
                                </td>
                            </tr>
                        </table>  
